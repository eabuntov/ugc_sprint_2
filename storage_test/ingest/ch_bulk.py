    ...
    with open(file_path) as f:
        for line in f:
            ...
            if len(batch) == 10_000:
                ...
                batch.clear()
        if batch:
            client.execute(f"INSERT INTO {table} ({','.join(columns)}) VALUES", batch)


bulk_insert(
    "/data/likes.jsonl", "movie_likes", ["user_id", "movie_id", "rating", "created_at"]
)
...
bulk_insert("/data/bookmarks.jsonl", "bookmarks", ["user_id", "movie_id", "created_at"])
